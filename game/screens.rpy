...
screen about():
    ...
    use game_menu(_("About the game"), scroll="viewport"):
...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("{} page"), auto=_("Autosave"), quick=_("Quick save"))
        ...
        vbox:
            ...
            hbox:
                ...
                vbox:
                    style_prefix "check"
                    label _("Skip")
                    textbutton _("Total text") action Preference("skip", "toggle")
                    textbutton _("After the election") action Preference("after choices", "toggle")
...
screen history():
    ...
    use game_menu(_("Story"), scroll=("vpgrid" if gui.history_height else "viewport"), yinitial=1.0):
...
screen keyboard_help():
    ...
    hbox:
        label _("Enter")
        text _("Passing through dialogues, activating the interface.")
    ...
    hbox:
        label _("Arrows")
        text _("Navigation through the interface.")
    ...
    hbox:
        label _("Page Up")
        text _("A throwback to the game's plot.")
    ...
    hbox:
        label "V"
        text _("Includes supported {a=https://www.renpy.org/l/voicing}speech synthesizer{/a}.")
...
screen mouse_help():
    ...
    hbox:
        label _("Wheel up\n")
        text _("Rollback according to the plot of the game.")
...
screen gamepad_help():
    ...
    textbutton _("Calibration") action GamepadCalibrate()
