...
label start:
    ...
    character_samurai "Thử tưởng tượng mày là 1 idol xem."
    character_lao "Idol à."
    stop music fadeout 1.0
    play music "idol yoasobi.mp3" fadein 1.0 volume 0.2
    scene bg idol
    with pixellate 
    pause (1.0)
    "..."
    ...
    character_lao "chắc là không được đâu."
    character_samurai "vậy thử tưởng tượng mình là 1 diễn viên nổi tiếng xem. Mày hay xem Phê Phim nên chắc rõ cái này lắm mà."
